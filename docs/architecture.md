...
**This file is generated.** Figures come from `results/results.json` via
`python -m pipeline.cite --render docs/architecture.template.md`.
...
Measured: 0 mismatches across
67,961 events on all four detectors, maximum absolute
difference 0, and
3,890 alerts in identical order.
